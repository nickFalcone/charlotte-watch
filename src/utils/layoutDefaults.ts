...
export const DEFAULT_LAYOUTS: Layouts = {
  ...
  md: [
    ...
    { i: 'stocks-1', x: 0, y: 4, w: 5, h: 4, minW: 3, minH: 3 },
    { i: 'weather-1', x: 5, y: 4, w: 5, h: 4, minW: 2, minH: 2 },
  ],
  sm: [
    { i: 'alerts-1', x: 0, y: 0, w: 3, h: 4, minW: 3, minH: 2 },
    { i: 'flights-1', x: 3, y: 0, w: 3, h: 4, minW: 3, minH: 4 },
    { i: 'stocks-1', x: 0, y: 4, w: 6, h: 4, minW: 3, minH: 3 },
    { i: 'weather-1', x: 0, y: 8, w: 6, h: 4, minW: 2, minH: 2 },
  ],
  xs: [
    { i: 'alerts-1', x: 0, y: 0, w: 4, h: 6, minW: 4, minH: 4 },
    { i: 'flights-1', x: 0, y: 6, w: 4, h: 6, minW: 3, minH: 4 },
    { i: 'stocks-1', x: 0, y: 12, w: 4, h: 6, minW: 3, minH: 4 },
    { i: 'weather-1', x: 0, y: 18, w: 4, h: 6, minW: 2, minH: 4 },
  ],
  xxs: [
    { i: 'alerts-1', x: 0, y: 0, w: 2, h: 6, minW: 2, minH: 4 },
    { i: 'flights-1', x: 0, y: 6, w: 2, h: 6, minW: 2, minH: 4 },
    { i: 'stocks-1', x: 0, y: 12, w: 2, h: 6, minW: 2, minH: 4 },
    { i: 'weather-1', x: 0, y: 18, w: 2, h: 6, minW: 2, minH: 4 },
  ],
};
