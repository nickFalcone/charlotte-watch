...
export const DEFAULT_WIDGET_CONFIGS: WidgetConfig[] = [
  ...
  { id: 'transit-1', type: 'transit', title: 'LYNX Transit', visible: true },
...
export const DEFAULT_LAYOUTS: Layouts = {
  lg: [
    ...
    { i: 'transit-1', x: 8, y: 0, w: 4, h: 5, minW: 3, minH: 3 },
  ...
  md: [
    ...
    { i: 'transit-1', x: 0, y: 4, w: 5, h: 5, minW: 3, minH: 3 },
  ...
  sm: [
    ...
    { i: 'transit-1', x: 0, y: 4, w: 6, h: 5, minW: 3, minH: 3 },
    { i: 'flights-1', x: 0, y: 9, w: 6, h: 5, minW: 3, minH: 4 },
    { i: 'stocks-1', x: 0, y: 14, w: 6, h: 4, minW: 3, minH: 3 },
    { i: 'weather-1', x: 0, y: 18, w: 6, h: 4, minW: 2, minH: 2 },
  ],
  xs: [
    { i: 'alerts-1', x: 0, y: 0, w: 4, h: 6, minW: 4, minH: 4 },
    { i: 'news-1', x: 0, y: 6, w: 4, h: 6, minW: 3, minH: 4 },
    { i: 'transit-1', x: 0, y: 12, w: 4, h: 6, minW: 3, minH: 4 },
    { i: 'flights-1', x: 0, y: 18, w: 4, h: 6, minW: 3, minH: 4 },
    { i: 'stocks-1', x: 0, y: 24, w: 4, h: 6, minW: 3, minH: 4 },
    { i: 'weather-1', x: 0, y: 30, w: 4, h: 6, minW: 2, minH: 4 },
  ],
  xxs: [
    { i: 'alerts-1', x: 0, y: 0, w: 2, h: 6, minW: 2, minH: 4 },
    { i: 'news-1', x: 0, y: 6, w: 2, h: 6, minW: 2, minH: 4 },
    { i: 'transit-1', x: 0, y: 12, w: 2, h: 6, minW: 2, minH: 4 },
    { i: 'flights-1', x: 0, y: 18, w: 2, h: 6, minW: 2, minH: 4 },
    { i: 'stocks-1', x: 0, y: 24, w: 2, h: 6, minW: 2, minH: 4 },
    { i: 'weather-1', x: 0, y: 30, w: 2, h: 6, minW: 2, minH: 4 },
  ],
};
